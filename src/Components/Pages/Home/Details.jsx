...
const Details = () => {
  return (
    <div className='bg-secondary py-16 mt-10'>
      <h1 className='text-3xl text-center mb-16 text-white'>Title 1</h1>
      <div className='flex justify-evenly items-center text-ptsans'>
        ...
        <div className='w-80 h-80 rounded-full bg-white text-secondary shadow-md mx-auto flex flex-col justify-center items-center'>
